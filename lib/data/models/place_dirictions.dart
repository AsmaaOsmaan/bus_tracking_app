...
class PlaceDirections{
  ...
  factory PlaceDirections.fromJson(Map<String,dynamic>json){
    ...
    if((data['legs'] as List).isNotEmpty){
      ...
      print('dataLegs::${leg['distance']['text']}');

    }
    return PlaceDirections(bound: bounds, polyLinePoints: PolylinePoints().decodePolyline(data['overview_polyline']['points']), totalDistance: distance, totalDuration: duration);
  }
